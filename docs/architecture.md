...
7. FantasyPros public API to normalized `FantasyPros-*` source tabs. Imported NFL player points across seasons rebuild `FantasyPros History`, while no provider feed alters the official draft results or private league inputs.
